                  ...
                  <Row>
                    <div className='col-md-12 col-lg-6'>
                      <div className='position-relative '>
                        <div className='font-16'><span className='fw-bold'>Order ID</span> <span className='gray'>1565</span></div>
                        <div className='font-16'><span className='fw-bold'>Order Status:</span> <span className='gray'>PURCHASE ORDER</span></div>
                        <div className='font-16'><span className='fw-bold'>Payment Status:</span> <span className='gray'>PENDING</span></div>
                    ...
                    <div className='col-md-12 col-lg-6'>
                      <div className='position-relative '>
                        ...
                        <div className='font-16'><span className='fw-bold'>PO Number:</span> <span className='gray'>1565</span></div>
                      ...
                      <Table responsive>
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td>Hello test</td>
                            <td>New purchase order 1565 processed successfully.</td>
                          </tr>
